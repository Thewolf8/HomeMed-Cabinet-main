...
import { Pill, Camera, X, Save } from 'lucide-react';
  ...
  if (!medicine) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h3 className="font-semibold text-lg">Medicine not found</h3>
        <button
          onClick={() => navigate('/medicines')}
          className="mt-4 px-6 py-2.5 rounded-xl bg-[#5F9E95] text-white text-sm font-medium"
        >
          Back to List
        </button>
      </div>
    ...
    <div className="pb-24 md:pb-8">
      <div className="px-4 py-4 max-w-2xl mx-auto">
        <motion.div
          ...
          className="mb-6"
        >
          <h2 className="font-serif text-2xl font-semibold mb-2">Edit Medicine</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate('/medicines')}
              className="flex-1 py-3.5 rounded-2xl glass text-sm font-medium hover:bg-white/10 transition-colors"
            >
              Cancel
            </motion.button>
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="flex-1 py-3.5 rounded-2xl bg-[#5F9E95] text-white font-medium text-sm hover:bg-[#3D6B65] transition-colors shadow-lg shadow-[#5F9E95]/20 flex items-center justify-center gap-2"
            >
